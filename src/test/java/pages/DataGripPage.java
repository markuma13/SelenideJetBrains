...
public class DataGripPage {
    ...
    private final static By MESSAGE_ENTERING_INVALID_EMAIL_LOCATOR = By.xpath("//div[@data-test='input__error-message']");
    ...
    private static final By MOVE_TOOLTIP_ELEMENT_LOCATOR = By.xpath("//*[name()='path' and contains(@d,'M12 21a9 9')]");
